...
TELEGRAM_BOT_TOKEN = '7555830733:AAHnXG7o249lbV7UOkefTzYXuOPZHvlF21I'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to the 𝘀𝟮 𝗗𝗱𝗼𝘀 ᵇʸ @xᴇɴxᴇᴜ! 🔥*\n\n"
...
async def manage(update: Update, context: CallbackContext):
    ...
    if chat_id != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ You need admin approval to use this command.please contact @xenxeu*", parse_mode='Markdown')
        return
